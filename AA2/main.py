    ...
    try:
        ...
        if hands:
            ...
            if len(lmList) > 0:
                ...
                # Check if first two fingers are up and move the cursor down

                # Check if first three fingers are up and move the cursor up

                # Check if last two fingers are up and move the cursor left

                # Check if last finger is up and move the cursor right
